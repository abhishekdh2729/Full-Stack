...
<body>
    <div class="container">
        ...
        if (isset($_POST["submit"])) {
            ...
            $sql = "INSERT INTO create_emp (id, fullname, dob, email, number, gender, state, city, qualification, experience,textarea) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
            ...
            if ($preparestmt) {
                mysqli_stmt_bind_param($stmt, "sssssssssss", $id, $fullname, $dob, $email, $number, $gender, $state, $city, $qualification, $experience,$textarea);
